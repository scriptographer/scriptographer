...
#include "uiGlobals.h"
#include "com_scriptographer_ui_HierarchyListBox.h"

/*
 * com.scriptographer.ui.HierarchyListBox
 */
...
void ASAPI HierarchyListBox_onDestroy(ADMHierarchyListRef list) {
	if (gEngine != NULL) {
		...
		// clear the handle
		gEngine->setIntField(env, listObj, gEngine->fid_ui_ListItem_listHandle, 0);
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyListBox_nativeCreateChildList(JNIEnv *env, jobject obj, jint entryRef) {
	try {
...
/*
 * com.scriptographer.ui.HierarchyListEntry nativeRemoveList(int arg1)
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_nativeRemoveList(JNIEnv *env, jobject obj, jint arg1) {
	try {
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyListBox_setEntrySize(JNIEnv *env, jobject obj, jint width, jint height, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		if (recursive) {
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyListBox_setEntryTextRect(JNIEnv *env, jobject obj, jint x, jint y, jint width, jint height, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		ADMRect rt;
		rt.left = x;
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyListBox_getNonLeafEntryWidth(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyListBox_setNonLeafEntryTextRect(JNIEnv *env, jobject obj, jint x, jint y, jint width, jint height, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		ADMRect rt;
		rt.left = x;
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_getNonLeafEntryTextRect(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		ADMRect rt;
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_getLeafEntryAt(JNIEnv *env, jobject obj, jint x, jint y) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_getSelectedLeafEntry(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
...
#define GET_ENTRIES(GET_NUMBER, INDEX_ENTRY) \
	try { \
		...
		jobjectArray res = env->NewObjectArray(length, gEngine->cls_ui_ListEntry, NULL); \
...
/*
 * com.scriptographer.ui.HierarchyListEntry[] getSelectedEntries()
 */
JNIEXPORT jobjectArray JNICALL Java_com_scriptographer_ui_HierarchyListBox_getSelectedEntries(JNIEnv *env, jobject obj) {
	GET_ENTRIES(NumberOfAllSelectedEntriesInHierarchy, IndexAllSelectedEntriesInHierarchy)
}

/*
 * com.scriptographer.ui.HierarchyListEntry[] getUnnestedSelectedEntries()
 */
JNIEXPORT jobjectArray JNICALL Java_com_scriptographer_ui_HierarchyListBox_getUnnestedSelectedEntries(JNIEnv *env, jobject obj) {
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_getLocalRect(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		ADMRect rt;
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_localToScreen(JNIEnv *env, jobject obj, jint x, jint y) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		DEFINE_ADM_POINT(pt, x, y);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_screenToLocal(JNIEnv *env, jobject obj, jint x, jint y) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		DEFINE_ADM_POINT(pt, x, y);
...
/*
 * com.scriptographer.ui.Point localToGlobal(int x, int y)
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_localToGlobal__II(JNIEnv *env, jobject obj, jint x, jint y) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		DEFINE_ADM_POINT(pt, x, y);
...
/*
 * com.scriptographer.ui.Point globalToLocal(int arg1, int arg2)
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_globalToLocal__II(JNIEnv *env, jobject obj, jint x, jint y) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		DEFINE_ADM_POINT(pt, x, y);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_localToGlobal__IIII(JNIEnv *env, jobject obj, jint x, jint y, jint width, jint height) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyListBox_globalToLocal__IIII(JNIEnv *env, jobject obj, jint x, jint y, jint width, jint height) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		DEFINE_ADM_RECT(rt, x, y, width, height);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyListBox_setIndentationWidth(JNIEnv *env, jobject obj, jint width, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		if (recursive)
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyListBox_getIndentationWidth(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyListBox_setLocalLeftMargin(JNIEnv *env, jobject obj, jint width) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyListBox_getLocalLeftMargin(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyListBox_getGlobalLeftMargin(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyListBox_setDivided(JNIEnv *env, jobject obj, jboolean divided, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		if (recursive)
 ...
 * boolean isDivided()
 */
JNIEXPORT jboolean JNICALL Java_com_scriptographer_ui_HierarchyListBox_isDivided(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyListBox_setFlags(JNIEnv *env, jobject obj, jint flags, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		if (recursive)
 ...
 * int getFlags()
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyListBox_getFlags(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 * void invalidate()
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyListBox_invalidate(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_com_scriptographer_ui_HierarchyListBox_getLeafEntries(JNIEnv *env, jobject obj) {
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyListBox_getLeafEntryIndex(JNIEnv *env, jobject obj, jobject entry) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyListBox_swap(JNIEnv *env, jobject obj, jint fromIndex, jint toIndex) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 * void deselectAll()
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyListBox_deselectAll(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_com_scriptographer_ui_HierarchyListBox_getExpandedEntries(JNIEnv *env, jobject obj) {
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyListBox_getExpandedEntryIndex(JNIEnv *env, jobject obj, jobject entry) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListBoxHandle(env, obj);
		ADMListEntryRef ent = gEngine->getHierarchyListEntryHandle(env, entry);
