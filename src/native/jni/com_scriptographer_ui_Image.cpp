...
#include "com_scriptographer_ui_Image.h"

/*
 * com.scriptographer.ui.Image
 */

/*
 * int nativeCreate(int width, int height, int type)
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_Image_nativeCreate(JNIEnv *env, jobject obj, jint width, jint height, jint type) {
	try {
		...
		gEngine->setIntField(env, obj, gEngine->fid_ui_Image_byteWidth, sADMImage->GetByteWidth(image));
		gEngine->setIntField(env, obj, gEngine->fid_ui_Image_bitsPerPixel, sADMImage->GetBitsPerPixel(image));
		return (jint)image;
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_Image_nativeDestroy(JNIEnv *env, jobject obj, jint handle, jint iconHandle) {
	try {
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_Image_nativeSetPixels___3IIII(JNIEnv *env, jobject obj, jintArray data, jint width, jint height, jint byteWidth) {
	try {
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_Image_nativeSetPixels__II(JNIEnv *env, jobject obj, jint handle, jint numBytes) {
	try {
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_Image_nativeGetPixels(JNIEnv *env, jobject obj, jintArray data, jint width, jint height, jint byteWidth) {
	try {
		ADMImageRef image = gEngine->getImageHandle(env, obj);
		jint len = env->GetArrayLength(data);
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_Image_nativeCreateIcon(JNIEnv *env, jobject obj) {
	try {
		ADMImageRef image = gEngine->getImageHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_Image_nativeEndDrawer(JNIEnv *env, jobject obj) {
	try {
		ADMImageRef image = gEngine->getImageHandle(env, obj);
