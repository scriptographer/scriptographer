 ...
 * -- GPL LICENSE NOTICE --
 *
 * $Id: com_scriptographer_ui_ListItem.cpp 578 2008-07-22 21:15:16Z lehni $
 */
...
#include "uiGlobals.h"
#include "com_scriptographer_ui_ListItem.h"

/*
 * com.scriptographer.ui.ListItem
 */
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_ListItem_nativeInit(JNIEnv *env, jobject obj, jint itemHandle) {
	try {
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_ListItem_setEntrySize(JNIEnv *env, jobject obj, jint width, jint height) {
	try {
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_ListItem_setTrackMask(JNIEnv *env, jobject obj, jint mask) {
	try {
 ...
 * int getTrackMask()
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_ListItem_getTrackMask(JNIEnv *env, jobject obj) {
	try {
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_ListItem_getEntrySize(JNIEnv *env, jobject obj) {
	try {
		ADMPoint pt;
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_ListItem_setEntryTextRect(JNIEnv *env, jobject obj, jint x, jint y, jint width, jint height) {
	try {
		ADMRect rt;
		rt.left = x;
		rt.top = y;
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_ListItem_getEntryTextRect(JNIEnv *env, jobject obj) {
	try {
		ADMRect rt;
 ...
 * int size()
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_ListItem_size(JNIEnv *env, jobject obj) {
	try {
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_ListItem_get__I(JNIEnv *env, jobject obj, jint index) {
	try {
...
/*
 * com.scriptographer.ui.ListEntry get(java.lang.String text)
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_ListItem_get__Ljava_lang_String_2(JNIEnv *env, jobject obj, jstring text) {
...
/*
 * com.scriptographer.ui.ListEntry getAt(int x, int y)
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_ListItem_getAt(JNIEnv *env, jobject obj, jint x, jint y) {
	try {
		ADMPoint pt;
		pt.h = x;
		pt.v = y;
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_ListItem_nativeSetBackgroundColor(JNIEnv *env, jobject obj, jint color) {
	try {
