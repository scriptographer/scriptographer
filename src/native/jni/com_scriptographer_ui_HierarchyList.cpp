 ...
 * -- GPL LICENSE NOTICE --
 *
 * $Id: com_scriptographer_ui_HierarchyList.cpp 578 2008-07-22 21:15:16Z lehni $
 */
...
#include "com_scriptographer_ui_HierarchyList.h"

/*
 * com.scriptographer.ui.HierarchyList
 */
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyList_nativeCreateChildList(JNIEnv *env, jobject obj, jint entryRef) {
	try {
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyList_nativeRemoveList(JNIEnv *env, jobject obj, jint arg1) {
	try {
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyList_setEntrySize(JNIEnv *env, jobject obj, jint width, jint height, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		if (recursive) {
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyList_setEntryTextRect(JNIEnv *env, jobject obj, jint x, jint y, jint width, jint height, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		ADMRect rt;
		rt.left = x;
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyList_getNonLeafEntryWidth(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyList_setNonLeafEntryTextRect(JNIEnv *env, jobject obj, jint x, jint y, jint width, jint height, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		ADMRect rt;
		rt.left = x;
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyList_getNonLeafEntryTextRect(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		ADMRect rt;
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_com_scriptographer_ui_HierarchyList_getSelectedEntries(JNIEnv *env, jobject obj) {
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_com_scriptographer_ui_HierarchyList_getUnnestedSelectedEntries(JNIEnv *env, jobject obj) {
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyList_getLocalRect(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		ADMRect rt;
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyList_localToScreen(JNIEnv *env, jobject obj, jint x, jint y) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		DEFINE_ADM_POINT(pt, x, y);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyList_screenToLocal(JNIEnv *env, jobject obj, jint x, jint y) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		DEFINE_ADM_POINT(pt, x, y);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyList_localToGlobal__II(JNIEnv *env, jobject obj, jint x, jint y) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		DEFINE_ADM_POINT(pt, x, y);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyList_globalToLocal__II(JNIEnv *env, jobject obj, jint x, jint y) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		DEFINE_ADM_POINT(pt, x, y);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyList_localToGlobal__IIII(JNIEnv *env, jobject obj, jint x, jint y, jint width, jint height) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
 ...
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ui_HierarchyList_globalToLocal__IIII(JNIEnv *env, jobject obj, jint x, jint y, jint width, jint height) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		DEFINE_ADM_RECT(rt, x, y, width, height);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyList_setIndentationWidth(JNIEnv *env, jobject obj, jint width, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		if (recursive)
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyList_getIndentationWidth(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyList_setLocalLeftMargin(JNIEnv *env, jobject obj, jint width) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyList_getLocalLeftMargin(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyList_getGlobalLeftMargin(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyList_setDivided(JNIEnv *env, jobject obj, jboolean divided, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		if (recursive)
 ...
 * boolean isDivided()
 */
JNIEXPORT jboolean JNICALL Java_com_scriptographer_ui_HierarchyList_isDivided(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyList_setFlags(JNIEnv *env, jobject obj, jint flags, jboolean recursive) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
		if (recursive)
 ...
 * int getFlags()
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_HierarchyList_getFlags(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
 ...
 * void invalidate()
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyList_invalidate(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyList_swap(JNIEnv *env, jobject obj, jint fromIndex, jint toIndex) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
 ...
 * void deselectAll()
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_HierarchyList_deselectAll(JNIEnv *env, jobject obj) {
	try {
		ADMHierarchyListRef list = gEngine->getHierarchyListHandle(env, obj);
