 ...
 * -- GPL LICENSE NOTICE --
 *
 * $Id: com_scriptographer_ui_TextValueItem.cpp 578 2008-07-22 21:15:16Z lehni $
 */

#include "StdHeaders.h"
#include "ScriptographerEngine.h"
#include "com_scriptographer_ui_TextValueItem.h"

/*
 * com.scriptographer.ui.TextValueItem
 */
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ui_TextValueItem_nativeSetUnits(JNIEnv *env, jobject obj, jint units) {
	try {
		ADMItemRef item = gEngine->getItemHandle(env, obj);
 ...
 * int nativeGetUnits()
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_ui_TextValueItem_nativeGetUnits(JNIEnv *env, jobject obj) {
	try {
		ADMItemRef item = gEngine->getItemHandle(env, obj);
