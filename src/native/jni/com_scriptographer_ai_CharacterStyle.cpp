...
/*
 * java.lang.Float nativeGetRotation()
 */
JNIEXPORT jobject JNICALL Java_com_scriptographer_ai_CharacterStyle_nativeGetRotation(JNIEnv *env, jobject obj) {
	CHARACTERSTYLE_GET_FLOAT(CharacterRotation)
}

/*
 * void nativeSetRotation(java.lang.Float value)
 */
JNIEXPORT void JNICALL Java_com_scriptographer_ai_CharacterStyle_nativeSetRotation(JNIEnv *env, jobject obj, jobject value) {
