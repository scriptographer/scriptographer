 ...
 */
JNIEXPORT jboolean JNICALL Java_com_scriptographer_adm_ListEntry_defaultTrack(JNIEnv *env, jobject obj, jobject tracker) {
	try {
...
/*
 * void defaultDraw(com.scriptographer.adm.Drawer arg1)
 */
JNIEXPORT void JNICALL Java_com_scriptographer_adm_ListEntry_defaultDraw(JNIEnv *env, jobject obj, jobject drawer) {
	try {
