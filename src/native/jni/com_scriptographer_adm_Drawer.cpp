 ...
 * int nativeGetFont()
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_adm_Drawer_nativeGetFont(JNIEnv *env, jobject obj) {
	try {
		ADMDrawerRef drawer = gEngine->getDrawerHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_adm_Drawer_nativeSetFont(JNIEnv *env, jobject obj, jint font) {
	try {
		ADMDrawerRef drawer = gEngine->getDrawerHandle(env, obj);
 ...
 */
JNIEXPORT void JNICALL Java_com_scriptographer_adm_Drawer_nativeDrawImage__III(JNIEnv *env, jobject obj, jint imageHandle, jint x, jint y) {
	try {
#ifdef MAC_ENV
		ADMDrawerRef drawer = gEngine->getDrawerHandle(env, obj);
 ...
 */
JNIEXPORT jint JNICALL Java_com_scriptographer_adm_Drawer_getTextHeight(JNIEnv *env, jobject obj, jstring text, jint width) {
	try {
		ADMDrawerRef drawer = gEngine->getDrawerHandle(env, obj);
		ASUnicode *chars = gEngine->convertString_ASUnicode(env, text);
