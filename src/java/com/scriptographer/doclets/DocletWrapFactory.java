 ...
 * @author lehni
 */
public class DocletWrapFactory extends WrapFactory {
	...
	public Scriptable wrapAsJavaObject(Context cx, Scriptable scope,
		...
		System.out.println("wrapAsJavaObject " + javaObj);
        return null; //return new UnsealedWrapper(scope, javaObj, staticType);
	}
}