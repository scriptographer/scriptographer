...
public class GraphicContext implements Cloneable {
     ...
     * Transform stack
     */
    protected List<TransformStackElement> transformStack = new ArrayList<TransformStackElement>();
    ...
    public Object clone(){
        ...
        // Transform stack
        copyGc.transformStack = new ArrayList<TransformStackElement>(
        		transformStack.size());
        for(int i=0; i<this.transformStack.size(); i++){
            TransformStackElement stackElement = this.transformStack.get(i);
            copyGc.transformStack.add(
            		(TransformStackElement) stackElement.clone());
        }
